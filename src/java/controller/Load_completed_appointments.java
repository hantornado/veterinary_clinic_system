 ...
 * @author hanto
 */
@WebServlet(name = "Load_completed_appointments", urlPatterns = {"/Load_completed_appointments"})
public class Load_completed_appointments extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if (completedApts != null) {
                ...
                out.println(li.setPricesListOfCompletedAppointments(completedApts));
            } else {
